...
public class ExpandableView extends LinearLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mExpandDuration = typedArray.getInt(R.styleable.ExpandableView_expDuration, EXPAND_DURATION);
            mExpandWithParentScroll = typedArray.getBoolean(R.styleable.ExpandableView_expWithParentScroll, false);
            mExpandScrollTogether = typedArray.getBoolean(R.styleable.ExpandableView_expExpandScrollTogether, false);
            typedArray.recycle();
        }
    }
